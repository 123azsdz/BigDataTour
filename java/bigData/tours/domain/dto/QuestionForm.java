package bigData.tours.domain.dto;  // DTO(Data Transfer Object)를 포함하는 패키지

import jakarta.validation.constraints.NotEmpty;  // 유효성 검사를 위한 어노테이션을 임포트
import lombok.Getter;  // Lombok을 통해 Getter 메서드를 자동 생성하기 위한 임포트
import lombok.Setter;  // Lombok을 통해 Setter 메서드를 자동 생성하기 위한 임포트
