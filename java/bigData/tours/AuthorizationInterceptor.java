...
import jakarta.servlet.http.HttpServletRequest;  // HTTP 요청을 처리하기 위한 클래스 임포트
import jakarta.servlet.http.HttpServletResponse;  // HTTP 응답을 처리하기 위한 클래스 임포트
import org.springframework.web.servlet.HandlerInterceptor;  // Spring MVC의 핸들러 인터셉터 인터페이스 임포트
