...
import bigData.tours.domain.dao.Question; // 질문 도메인 클래스
import bigData.tours.domain.dao.QuestionAnswer; // 질문 답변 도메인 클래스
import bigData.tours.domain.dto.QuestionAnswerForm; // 질문 답변 폼 DTO
import bigData.tours.service.QuestionAnswerService; // 질문 답변 서비스
import bigData.tours.service.QuestionService; // 질문 서비스
...
import org.springframework.web.bind.annotation.*; // Spring MVC에서 사용할 어노테이션들

import java.time.LocalDateTime; // 날짜 및 시간 클래스
