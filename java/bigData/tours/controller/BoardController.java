...
import bigData.tours.domain.dao.Member1;
import bigData.tours.domain.dto.BoardAnswerForm;
import bigData.tours.domain.dto.BoardForm;
import bigData.tours.service.MemberService;
import bigData.tours.service.BoardService;
...
public class BoardController {
    ...
    public String boardNoticeCreate(@Valid @ModelAttribute("boardForm") BoardForm boardForm,
        ...
        boardService.createNotice(board); // 게시글 저장
        model.addAttribute("loginMember", loginMember); // 로그인 회원 정보 추가
