...
import bigData.tours.domain.dto.MemberForm; // 회원 정보 폼 DTO
...
import org.springframework.validation.annotation.Validated; // 유효성 검사를 위한 어노테이션
import org.springframework.web.bind.annotation.*; // 웹 요청 처리 관련 어노테이션

import java.util.List; // 리스트 컬렉션을 사용하기 위한 임포트
